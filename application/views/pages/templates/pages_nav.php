<div class="navbar-fixed">
      <!-- <nav class="white" role="navigation" style="top:0px;"> -->
      <nav class="white teal-text" role="navigation" style="top:0px;">
        <div class="nav-wrapper container"><a id="logo-container" href="<?php echo base_url(); ?>" class="brand-logo">
