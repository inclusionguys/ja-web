...
class Dashboard extends CI_Controller {
	...
	public function index()
	{
		...
		$data['member_type'] =  $this -> session -> userdata()['usertype'];
	...
	public function profile($username = null, $application = null)
	{

		$username =  $this -> session -> userdata()['user_details']->display_name;
