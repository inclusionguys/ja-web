    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col s12 m9">
          <h5>Happier Customers = Happier merchants</h5>
          <p class="flow-text">
            Increase your revenues by unlocking the value of loyalty from your customers. <br />
      ...
      <div class="col s12 m12">
       <h5>All your rewards on your phone</h5>
       <p class="flow-text">
        <img class="right" src="<?php echo base_url();?>assets/img/lipa-na-mpesa-customer-merchant.jpg" style="max-width:  400px;">
